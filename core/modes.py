...
MODES = {
'normal': Mode('normal', 'Normal', 'Default; balanced speed and stealth', delay_ms=0, jitter_ms=0, aggressive=False),
'silent': Mode('silent', 'Silent', 'Slow and stealthy (recommended for live targets)', delay_ms=150, jitter_ms=75, aggressive=False),
'brutal': Mode('brutal', 'Brutal', 'Aggressive & fast (noisy). Only with explicit permission!', delay_ms=0, jitter_ms=0, aggressive=True)
}
